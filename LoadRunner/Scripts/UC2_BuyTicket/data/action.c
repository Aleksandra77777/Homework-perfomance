Action()
{
	...
	web_custom_request("login.pl", 
		...
		"Snapshot=t9.inf", 
		"Mode=HTTP", 
		"Body=userSession=138841.034750911HVtVzDfpHcftcitQpiVtDf&username=jojo&password=bean&login.x=56&login.y=11&JSFormSubmit=off", 
		LAST);
	...
	web_custom_request("reservations.pl_2", 
		...
		"Snapshot=t22.inf", 
		"Mode=HTTP", 
		"Body=advanceDiscount=0&depart=Denver&departDate=04%2F26%2F2024&arrive=London&returnDate=04%2F29%2F2024&numPassengers=1&seatPref=Window&seatType=Coach&findFlights.x=67&findFlights.y=13&.cgifields=roundtrip&.cgifields=seatType&.cgifields=seatPref", 
		LAST);
	...
	web_custom_request("reservations.pl_3", 
		...
		"Snapshot=t23.inf", 
		"Mode=HTTP", 
		"Body=outboundFlight=020%3B338%3B04%2F26%2F2024&numPassengers=1&advanceDiscount=0&seatType=Coach&seatPref=Window&reserveFlights.x=49&reserveFlights.y=7", 
		LAST);
	...
	web_custom_request("reservations.pl_4", 
		...
		"Snapshot=t24.inf", 
		"Mode=HTTP", 
		"Body=firstName=Jojo&lastName=Bean&address1=Moscow&address2=123009&pass1=Jojo+Bean&creditCard=123456789&expDate=08%2F27&saveCC=on&oldCCOption=on&numPassengers=1&seatType=Coach&seatPref=Window&outboundFlight=020%3B338%3B04%2F26%2F2024&advanceDiscount=0&returnFlight=&JSFormSubmit=off&buyFlights.x=43&buyFlights.y=6&.cgifields=saveCC", 
		LAST);
