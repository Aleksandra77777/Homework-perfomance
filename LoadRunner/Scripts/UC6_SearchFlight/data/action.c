Action()
{
	...
	web_custom_request("login.pl", 
		...
		"Snapshot=t9.inf", 
		"Mode=HTTP", 
		"Body=userSession=139005.858809235HVfAVVDpizcftcQAApziDVHf&username=jojo&password=bean&login.x=44&login.y=12&JSFormSubmit=off", 
		LAST);
	...
	web_custom_request("reservations.pl_2", 
		...
		"Snapshot=t22.inf", 
		"Mode=HTTP", 
		"Body=advanceDiscount=0&depart=London&departDate=05%2F19%2F2024&arrive=Denver&returnDate=05%2F20%2F2024&numPassengers=1&seatPref=None&seatType=Coach&findFlights.x=55&findFlights.y=10&.cgifields=roundtrip&.cgifields=seatType&.cgifields=seatPref", 
		LAST);
	...
	web_custom_request("reservations.pl_3", 
		...
		"Snapshot=t23.inf", 
		"Mode=HTTP", 
		"Body=outboundFlight=200%3B338%3B05%2F19%2F2024&numPassengers=1&advanceDiscount=0&seatType=Coach&seatPref=None&reserveFlights.x=62&reserveFlights.y=12", 
		LAST);
